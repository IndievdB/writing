...
import { analyzeWord } from './phonology.js?v=34';
import { VOWELS } from './lexicon.js?v=34';
import { classifyOrigin } from './etymology.js?v=34';
import { FUNCTION_WORDS, IRREGULAR_PAST, UNSTRESSED_MONOSYLLABLES, DUAL_STRESS_MONOSYLLABLES } from './wordlists.js?v=34';
